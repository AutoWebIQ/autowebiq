...
COMPONENTS = [
    ...
    # ==================== PRICING SECTION (1 variant - 50th component) ====================
    {
        "component_id": "pricing_table_v1",
        "name": "Pricing Table",
        "category": "pricing",
        "type": "pricing",
        "description": "Complete pricing table with tiers",
        "tags": ["pricing", "plans", "subscription", "tiers"],
        "responsive": True,
        "customization_points": ["section_title", "plans"],
        "html": """<section style="padding:100px 40px;background:#fff"><div style="max-width:1200px;margin:0 auto"><h2 style="text-align:center;font-size:3rem;font-weight:800;margin-bottom:16px">{{ section_title }}</h2><p style="text-align:center;color:#6b7280;font-size:1.125rem;margin-bottom:60px">Choose the perfect plan for your needs</p><div style="display:grid;grid-template-columns:repeat(3,1fr);gap:32px"><div style="background:#fff;border:2px solid #e5e7eb;border-radius:16px;padding:40px;transition:all 0.3s"><h3 style="font-size:1.5rem;font-weight:700;margin-bottom:12px">Starter</h3><div style="font-size:3rem;font-weight:900;margin-bottom:8px">$19<span style="font-size:1rem;color:#6b7280;font-weight:400">/month</span></div><p style="color:#6b7280;margin-bottom:32px">Perfect for individuals</p><ul style="list-style:none;padding:0;margin-bottom:32px"><li style="padding:8px 0;color:#1a1a1a">✓ 5 Projects</li><li style="padding:8px 0;color:#1a1a1a">✓ 10GB Storage</li><li style="padding:8px 0;color:#1a1a1a">✓ Basic Support</li><li style="padding:8px 0;color:#9ca3af">✗ Advanced Features</li></ul><a href="#" style="display:block;text-align:center;background:#f3f4f6;color:#1a1a1a;padding:14px;border-radius:8px;text-decoration:none;font-weight:700">Get Started</a></div><div style="background:#667eea;border:2px solid #667eea;border-radius:16px;padding:40px;transform:scale(1.05);box-shadow:0 20px 40px rgba(102,126,234,0.3);color:#fff;position:relative"><div style="position:absolute;top:-12px;left:50%;transform:translateX(-50%);background:#fbbf24;color:#1a1a1a;padding:4px 16px;border-radius:20px;font-size:0.875rem;font-weight:700">POPULAR</div><h3 style="font-size:1.5rem;font-weight:700;margin-bottom:12px">Professional</h3><div style="font-size:3rem;font-weight:900;margin-bottom:8px">$49<span style="font-size:1rem;opacity:0.8;font-weight:400">/month</span></div><p style="opacity:0.9;margin-bottom:32px">For growing businesses</p><ul style="list-style:none;padding:0;margin-bottom:32px"><li style="padding:8px 0">✓ Unlimited Projects</li><li style="padding:8px 0">✓ 100GB Storage</li><li style="padding:8px 0">✓ Priority Support</li><li style="padding:8px 0">✓ Advanced Features</li></ul><a href="#" style="display:block;text-align:center;background:#fff;color:#667eea;padding:14px;border-radius:8px;text-decoration:none;font-weight:700">Get Started</a></div><div style="background:#fff;border:2px solid #e5e7eb;border-radius:16px;padding:40px;transition:all 0.3s"><h3 style="font-size:1.5rem;font-weight:700;margin-bottom:12px">Enterprise</h3><div style="font-size:3rem;font-weight:900;margin-bottom:8px">$99<span style="font-size:1rem;color:#6b7280;font-weight:400">/month</span></div><p style="color:#6b7280;margin-bottom:32px">For large organizations</p><ul style="list-style:none;padding:0;margin-bottom:32px"><li style="padding:8px 0;color:#1a1a1a">✓ Everything in Pro</li><li style="padding:8px 0;color:#1a1a1a">✓ Unlimited Storage</li><li style="padding:8px 0;color:#1a1a1a">✓ Dedicated Support</li><li style="padding:8px 0;color:#1a1a1a">✓ Custom Integrations</li></ul><a href="#" style="display:block;text-align:center;background:#1a1a1a;color:#fff;padding:14px;border-radius:8px;text-decoration:none;font-weight:700">Contact Sales</a></div></div></div></section>"""
    }
]
