...
### Test Backend Health:
```bash
curl https://aiweb-builder-2.preview.emergentagent.com/api/health | json_pp
```
...
1. **Health Check Endpoint**
   - Monitor: `https://aiweb-builder-2.preview.emergentagent.com/api/health`
...
```bash
# Test new connection
curl https://aiweb-builder-2.preview.emergentagent.com/api/health
