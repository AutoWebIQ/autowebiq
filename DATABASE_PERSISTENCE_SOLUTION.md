...
### Test Backend Health:
```bash
curl https://multiagent-web.preview.emergentagent.com/api/health | json_pp
```
...
1. **Health Check Endpoint**
   - Monitor: `https://multiagent-web.preview.emergentagent.com/api/health`
...
```bash
# Test new connection
curl https://multiagent-web.preview.emergentagent.com/api/health
