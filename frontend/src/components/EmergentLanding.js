        ...
        <div className="hero-container">
          ...
          <div className="hero-right">
            <div className="video-container">
              ...
              <div className="emergent-badge">emergent</div>
              <div className="live-badge">⚡ Going Live on Monday</div>
              <h2 className="video-title">Got an idea?</h2>
              <p className="video-subtitle">
                🎥 Introducing Idea Incubator 🔥<br />
                Emergent's launchpad for 25 ambitious builders who want<br />
                to ship real products and earn real revenue.
              </p>
              <Button className="apply-btn">Apply Now <ArrowRight size={16} /></Button>
              <div className="perks-bar">
                <span>$2pcs</span>
                <span>$2k worth of Marketing</span>
                <span className="highlight">$50k worth of Prizes</span>
                <span>Product Hunt launch support</span>
                <span className="highlight">$85K worth of Prizes</span>
              ...
              <div className="stats-grid">
                ...
                <div className="stat">
                  <div className="stat-value highlight-stat">Y</div>
