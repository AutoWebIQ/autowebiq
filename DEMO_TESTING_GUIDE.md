...
curl -X GET "https://multiagent-web.preview.emergentagent.com/api/v2/users/me" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Check validation system
curl -X GET "https://multiagent-web.preview.emergentagent.com/api/v2/validate/checks"

# Check health
curl -X GET "https://multiagent-web.preview.emergentagent.com/api/health"
```
...
- Verify backend health: curl https://multiagent-web.preview.emergentagent.com/api/health
...
### Check Validation System:
```bash
curl -s https://multiagent-web.preview.emergentagent.com/api/v2/validate/checks | python -m json.tool
```
