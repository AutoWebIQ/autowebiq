...
curl -X GET "https://aiweb-builder-2.preview.emergentagent.com/api/v2/users/me" \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Check validation system
curl -X GET "https://aiweb-builder-2.preview.emergentagent.com/api/v2/validate/checks"

# Check health
curl -X GET "https://aiweb-builder-2.preview.emergentagent.com/api/health"
```
...
- Verify backend health: curl https://aiweb-builder-2.preview.emergentagent.com/api/health
...
```bash
curl -s https://aiweb-builder-2.preview.emergentagent.com/api/health | python -m json.tool
```

### Check Validation System:
```bash
curl -s https://aiweb-builder-2.preview.emergentagent.com/api/v2/validate/checks | python -m json.tool
```
